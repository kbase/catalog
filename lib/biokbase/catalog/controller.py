...
class CatalogController:
    ...
    def log_exec_stats(self, username, token, user_id, app_module_name, app_id, func_module_name,
        ...
        my_list  = [user_id, app_module_name, app_id, func_module_name, func_name,
                                   git_commit_hash, creation_time, exec_start_time, finish_time,
                                   is_error, job_id]
        aesa0 = " ".join(map(str, my_list))
        logging.info(aesa0)
       
        
        my_list2 = [user_id, app_module_name, app_id, func_module_name, func_name,
                                   git_commit_hash, creation_time, exec_start_time, finish_time,
                                   is_error, job_id]
        adsr = " ".join(map(str, my_list2))
        logging.info(adsr)
        ...
        my_list3 = [app_module_name, app_id, creation_time, exec_start_time, finish_time, is_error, "a", "*", "then", "w", week_time_range]
        aesa1 = " ".join(map(str, my_list3))
        logging.info(aesa1)
