...
public class RepoVersion {
    ...
    public RepoVersion withWithDisabled(Long withDisabled) {
        this.withDisabled = withDisabled;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("RepoVersion"+" [timestamp=")+ timestamp)+", gitCommitHash=")+ gitCommitHash)+", withDisabled=")+ withDisabled)+", additionalProperties=")+ additionalProperties)+"]");
    }
