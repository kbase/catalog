...
public class CatalogClient {
     ...
     */
    public Long isRepoRegistered(CurrentRepoParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public Long getRepoLastTimestamp(CurrentRepoParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<Long>> retType = new TypeReference<List<Long>>() {};
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public List<RepoVersion> listRepoVersions(CurrentRepoParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
     ...
     * <pre>
     * </pre>
     * @param   params   instance of type {@link us.kbase.catalog.SetRepoStateParams SetRepoStateParams}
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public void setRepoState(SetRepoStateParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<Object> retType = new TypeReference<Object>() {};
        caller.jsonrpcCall("Catalog.set_repo_state", args, retType, false, true, jsonRpcContext);
    }
     ...
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public String getRepoState(CurrentRepoParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(params);
        TypeReference<List<String>> retType = new TypeReference<List<String>>() {};
        List<String> res = caller.jsonrpcCall("Catalog.get_repo_state", args, retType, true, false, jsonRpcContext);
        return res.get(0);
    }
}
