...
class CatalogTestUtil:
    ...
    def _setup_config(self):
        ...
        self.scratch_dir = os.path.join(self.test_dir, 'temp_test_files',
    ...
    def _initialize_mongo_data(self):
        ...
        load_count = 0
        modules_document_dir = os.path.join(self.test_dir, 'initial_mongo_state',
                                            MongoCatalogDBI._MODULES)
        ...
        logs_document_dir = os.path.join(self.test_dir, 'initial_mongo_state',
                                         MongoCatalogDBI._BUILD_LOGS)
        ...
        favorites_document_dir = os.path.join(self.test_dir, 'initial_mongo_state',
                                              MongoCatalogDBI._FAVORITES)
        ...
        volume_mounts_dir = os.path.join(self.test_dir, 'initial_mongo_state',
                                         MongoCatalogDBI._VOLUME_MOUNTS)
        ...
        client_groups_dir = os.path.join(self.test_dir, 'initial_mongo_state',
                                         MongoCatalogDBI._CLIENT_GROUPS)
