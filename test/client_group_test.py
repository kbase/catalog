...
class ClientGroupMethodsTest(unittest.TestCase):
    ...
    def test_basics(self):
        ...
        self.catalog.set_client_group_config(adminCtx,
                                             {'module_name': 'rna',
                                              'function_name': 'run_something',
                                              'client_groups': ['g1']})
        self.catalog.set_client_group_config(adminCtx,
                                             {'module_name': 'rna',
                                              'function_name': 'run_something2',
                                              'client_groups': ['g1', 'g2']})
        self.catalog.set_client_group_config(adminCtx,
                                             {'module_name': 'rna',
                                              'function_name': 'run_something3',
                                              'client_groups': ['g3']})
        self.catalog.set_client_group_config(adminCtx,
                                             {'module_name': 'DNA',
                                              'function_name': 'run_something',
        ...
        groups = self.catalog.get_client_groups(anonCtx, {
            'app_ids': ['dna/run_something', 'MegaHit/run_Megahit']})[0]
        self.assertEqual(len(groups), 2)

        groups = self.catalog.get_client_groups(anonCtx, {
            'app_ids': ['dna/run_something', 'MegaHit/run_Megahit', 'asdfasd']})[0]
        self.assertEqual(len(groups), 2)
        ...
        self.catalog.set_client_group_config(adminCtx,
                                             {'module_name': 'DNA',
                                              'function_name': 'run_something',
                                              'client_groups': ['new_g1', 'new_g2', 'new_g3']})
        groups = self.catalog.get_client_groups(anonCtx, {'app_ids': ['dna/run_something']})[0]
        self.assertEqual(len(groups), 1)
        self.assertEqual(groups[0]['app_id'], 'dna/run_something')
        ...
        self.assertEqual(len(groups), 1)
        groups = \
        self.catalog.list_client_group_configs(anonCtx, {'function_name': 'run_something'})[0]
        self.assertEqual(len(groups), 2)
    ...
    def test_volume_mount_configs(self):
        ...
        vol_mounts = \
        self.catalog.list_volume_mounts(adminCtx, {'module_name': 'VolmountModTest1'})[0]
        ...
        vol_mounts = \
        self.catalog.list_volume_mounts(adminCtx, {'module_name': 'VolMountModTest2'})[0]
        ...
        vol_mounts = self.catalog.list_volume_mounts(adminCtx, {'module_name': 'VolMountModTest2',
                                                                'function_name': 'func1'})[0]
        self.assertEqual(len(vol_mounts), 2)
        ...
        with self.assertRaises(ValueError) as e:
            self.catalog.remove_volume_mount(adminCtx,
                                             {'module_name': 'Tester2', 'function_name': 'my_app'})
        self.assertEqual(str(e.exception),
                         'client_group parameter field is required')
        vol_mounts = self.catalog.list_volume_mounts(adminCtx, {})[0]
        self.assertEqual(len(vol_mounts), 5)
