...
class DynamicServiceSupportTest(unittest.TestCase):
    ...
    def test_list_dynamic_modules(self):
        ...
        self.assertEqual(mods[0]['docker_img_name'],
                         'dockerhub-ci.kbase.us/kbase:dynamicservice.9bedf67800b2923982bdf60c89c57ce6fd2d9a1c')
        ...
        self.assertEqual(mods[1]['docker_img_name'],
                         'dockerhub-ci.kbase.us/kbase:dynamicservice.12edf67800b2923982bdf60c89c57ce6fd2d9a1c')
        ...
        self.assertEqual(mods[2]['docker_img_name'],
                         'dockerhub-ci.kbase.us/kbase:dynamicservice2.29dc505febb8f4cccb2078c58ded0de3320534d7')
        ...
        self.assertEqual(mods[3]['docker_img_name'],
                         'dockerhub-ci.kbase.us/kbase:dynamicservice.49dc505febb8f4cccb2078c58ded0de3320534d7')
        ...
        self.assertEqual(mods[0]['docker_img_name'],
                         'dockerhub-ci.kbase.us/kbase:dynamicservice.b06c5f9daf603a4d206071787c3f6184000bf128')
        ...
        self.assertEqual(mods[0]['docker_img_name'],
                         'dockerhub-ci.kbase.us/kbase:dynamicservice2.39dc505febb8f4cccb2078c58ded0de3320534d7')
    ...
    def test_version_fetch_basics(self):
        ...
        ver = self.catalog.module_version_lookup(self.cUtil.anonymous_ctx(),
                                                 {'module_name': 'DynamicService',
                                                  'lookup': '49dc505febb8f4cccb2078c58ded0de3320534d7'
                                                  })[0]
        self.assertEqual(ver['version'], '2.1.8')
        self.assertEqual(ver['git_commit_hash'], '49dc505febb8f4cccb2078c58ded0de3320534d7')
        self.assertEqual(ver['module_name'], 'DynamicService')
        ...
        ver = self.catalog.module_version_lookup(self.cUtil.anonymous_ctx(),
                                                 {'module_name': 'DynamicService',
                                                  'lookup': '12edf67800b2923982bdf60c89c57ce6fd2d9a1c'
                                                  })[0]
        self.assertEqual(ver['version'], '1.0.2')
        self.assertEqual(ver['git_commit_hash'], '12edf67800b2923982bdf60c89c57ce6fd2d9a1c')
        self.assertEqual(ver['module_name'], 'DynamicService')
        ...
        ver = self.catalog.module_version_lookup(self.cUtil.anonymous_ctx(),
                                                 {'module_name': 'DynamicService2',
                                                  'lookup': '39dc505febb8f4cccb2078c58ded0de3320534d7'
                                                  })[0]
        self.assertEqual(ver['module_name'], 'DynamicService2')
        self.assertEqual(ver['git_commit_hash'], '39dc505febb8f4cccb2078c58ded0de3320534d7')
        self.assertEqual(ver['version'], '1.5.1')
        ...
        ver = self.catalog.module_version_lookup(self.cUtil.anonymous_ctx(),
                                                 {'module_name': 'DynamicService',
                                                  'lookup': 'b06c5f9daf603a4d206071787c3f6184000bf128'
                                                  })[0]
        self.assertEqual(ver['module_name'], 'DynamicService')
        self.assertEqual(ver['git_commit_hash'], 'b06c5f9daf603a4d206071787c3f6184000bf128')
        self.assertEqual(ver['version'], '0.0.5')
        ...
        with self.assertRaises(ValueError) as e:
            ver = self.catalog.module_version_lookup(self.cUtil.anonymous_ctx(),
                                                     {'module_name': 'DynamicService',
                                                      'lookup': 'b843888e962642d665a3b0bd701ee630c01835e6'
                                                      })[0]
        self.assertEqual(str(e.exception),
        ...
        with self.assertRaises(ValueError) as e:
            ver = self.catalog.module_version_lookup(self.cUtil.anonymous_ctx(),
                                                     {'module_name': 'DynamicService2',
                                                      'lookup': '19dc505febb8f4cccb2078c58ded0de3320534d7'
                                                      })[0]
        self.assertEqual(str(e.exception),
        ...
        with self.assertRaises(ValueError) as e:
            ver = self.catalog.module_version_lookup(self.cUtil.anonymous_ctx(),
                                                     {'module_name': 'DynamicService',
                                                      'lookup': 'd6cd1e2bd19e03a81132a23b2025920577f84e37'
                                                      })[0]
        self.assertEqual(str(e.exception),
